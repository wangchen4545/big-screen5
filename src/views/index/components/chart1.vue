...
<style lang="scss">
.big-screen-chart-date{
    .el-picker-panel{
        width: 768px;
        height: 825px;
        background: rgba(8,16,22,0.9);
        box-shadow: 0px 0 96px 0px rgba(0,0,0,0.12);
        border-radius: 32px;
    ...
    .el-date-picker__header-label{
        font-size: 40px;
        line-height: 59px;
        text-shadow: 0px 0px 28px rgba(0,0,0,0.12);
        color: #C5E4F9;
    }
...
text-transform: none; */
    ...
    .el-picker-panel__icon-btn{
        color: #FFFFFF;
        box-shadow: 0px 0 28px 0px rgba(0,0,0,0.12);
        font-size: 25px;
    }
    .el-date-table td.current:not(.disabled) .el-date-table-cell__text{
        background: rgba(165, 241, 255, 1);
        color: rgba(0, 0, 0, 1);
    }
}
.min-chart{
