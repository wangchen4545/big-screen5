	...
	<div class="ywfw-box">
		...
		<div class="box-content">
			...
			<div class="fault-statistics">
				...
				<div class="distribution-title">故障级别分布</div>
				...
				<div class="fault">
					<div class="failt-title">共 <span class="failt-total">13</span>个中高级调度故障</div>
			...
			<div class="notice">
				...
				<div class="implement-changes">
					...
					<div class="implement-changes-box">
						<div
							class="implement-changes-list"
							v-for="(item,index) in implementChangesList"
							:key="index"
						>
				...
				<div class="unresolved-alarm">
					...
					<div class="unresolved-alarm-box">
						<div
							class="unresolved-alarm-list"
							v-for="(item,index) in unresolvedAlarmList"
							:key="index"
						>
							<div class="list-img"></div>
							<div class="list-txt">{{item.txt}}</div>
